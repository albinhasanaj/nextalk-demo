    ...
    <main className="scrollbar ">
      ...
      <div className="absolute inset-0 image__gradient ">
        ...
        <nav className="relative flex justify-between px-[9rem] pt-[2.5rem] z-10">
          <h1 className="text-white text-[2rem] font-[700] hover:cursor-not-allowed">NexTalk</h1>
          <div className="flex gap-[1.5rem] text-white items-center">
            <Link href="/" className="text-[1.2rem] hover:underline hover:cursor-not-allowed"> Home </Link>
            <Link href="/about" className="text-[1.2rem] hover:underline hover:cursor-not-allowed"> About </Link>
      ...
      <footer className="flex justify-between items-center bg-[#222] h-[20rem] text-white px-[8rem]">
        <div>
          ...
          <ul>
            <li>
              <Link href="/" className="hover:underline hover:cursor-not-allowed">Home</Link>
            </li>
            <li>
              <Link href="/about" className="hover:underline hover:cursor-not-allowed">About</Link>
            </li>
            <li>
              <Link href="/contact" className="hover:underline hover:cursor-not-allowed">Contact</Link>
            </li>
            <li>
              <Link href="/login" className="hover:underline hover:cursor-not-allowed">Log In</Link>
            </li>
            <li>
              <Link href="/signup" className="hover:underline hover:cursor-not-allowed">Sign Up</Link>
            </li>
          </ul>
        </div>
        <div className="flex flex-col mt-[5rem]  text-center">
          ...
          <div className="flex flex-col mt-[6rem]">
            ...
            <Link href="/" className="hover:underline text-[rgba(255,255,255,0.5)] font-normal">oliver.swedishservers.com</Link>
          </div>
        </div>
        <div>
          <span className="text-[rgba(255,255,255,0.5)] font-normal hover:cursor-not-allowed">Terms & Policies</span>
          <ul>
            <li>
              <Link href="/about" className="hover:underline font-[600] hover:cursor-not-allowed">Terms of Service</Link>
            </li>
            <li>
              <Link href="/" className="hover:underline font-[600] hover:cursor-not-allowed">Privacy Policy</Link>
            </li>
            <li>
              <Link href="/" className="hover:underline font-[600] hover:cursor-not-allowed">Brand Guidelines</Link>
            </li>
            <li>
              <Link href="/contact" className="hover:underline font-[600] hover:cursor-not-allowed">Cookie Policy</Link>
            </li>
          </ul>
        </div>
      </footer>
